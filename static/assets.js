...
(() => {
  ...
  document.addEventListener("DOMContentLoaded", (e) => {
    ...
    backButton = document.querySelector(".previous-button")
    ...
    nextButton.addEventListener('click', function() { 
      ...
      if(count == 2 && flag == 0){
        flag = 1
        displayName = document.querySelector("#step1-name").value
        email = document.querySelector("#step1-email").value
        password = document.querySelector("#step2-password").value
